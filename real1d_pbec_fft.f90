...
MODULE COMM_DATA
  INTEGER, PARAMETER :: NRUN = 25*10000, LSTORE = 4000, IMSTORE = NRUN / 5
...
!  			
  REAL (8), PARAMETER :: NU = 0.5D0, NU2 = NU * NU
  REAL (8), PARAMETER :: G0 = -10.0D0, G01 = 0.0142D0, GAM_EFF0 = 0.01D0
